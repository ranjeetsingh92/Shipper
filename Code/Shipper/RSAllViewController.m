...
- (void)viewDidLoad {
    ...
    [SVProgressHUD show];
    [self performSelector:@selector(getAllRecord) withObject:nil afterDelay:0];
    [NSTimer scheduledTimerWithTimeInterval:30 target:self selector:@selector(getAllRecord) userInfo:nil repeats:YES];
...
-(void)getAllRecord
{
    ...
    if (self.dataArray.count == 0)
    {
        ...
        NSString *userUpdate = [NSString stringWithFormat:@"{\"SubscriptionId\":%@,\"CreatedBy\":\"%@\",\"Status\":\"%@\",\"pageIndex\":%d,\"PageSize\":%d,\"TruckRequestStatus\":%@,\"IsAll\":%d}",[logDict objectForKey:@"subscriptionId"],[logDict objectForKey:@"emailId"],@"0",pageIndx,pageSiz,@"0",true];
        NSLog(@"%@",userUpdate);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.dataArray.count != 0) {
        if(indexPath.row <[self.dataArray count]){
            ...
            if ([cell.labelStatus.text isEqualToString:@"For Approval Load"])
            {
                [cell.btnCancelLoad      setHidden:NO];
                [cell.btnEditLoad        setHidden:NO];
                [cell.btnDeleteLoad      setHidden:NO];
                ...
                [cell.btnCancelLoad      setFrame:CGRectMake(8,  155, 25, 25)];
                [cell.btnEditLoad        setFrame:CGRectMake(32, 155, 25, 25)];
                [cell.btnDeleteLoad      setFrame:CGRectMake(62, 155, 25, 25)];
                [cell.btnFindTruck       setFrame:CGRectMake(91, 155, 25, 25)];
                [cell.btnShowDetails     setFrame:CGRectMake(151,155, 25, 25)];
                

            }
            else if ([cell.labelStatus.text isEqualToString:@"New Load"])
            {
                [cell.btnCancelLoad setHidden:NO];
                [cell.btnEditLoad setHidden:NO];
                [cell.btnDeleteLoad setHidden:NO];
            ...
            else if ([cell.labelStatus.text isEqualToString:@"Bidding"])
            {
                [cell.btnCancelLoad setHidden:NO];
                ...
                [cell.btnEditLoad        setFrame:CGRectMake(32, 155, 25, 25)];
                [cell.btnDeleteLoad      setFrame:CGRectMake(62, 155, 25, 25)];
                [cell.btnFindTruck       setFrame:CGRectMake(32, 155, 25, 25)];
                [cell.btnShowDetails     setFrame:CGRectMake(151,155, 25, 25)];


            }
            else if ([cell.labelStatus.text isEqualToString:@"Booked"])
            {
                [cell.btnCancelLoad setHidden:NO];
                [cell.btnEditLoad setHidden:YES];
                [cell.btnDeleteLoad setHidden:YES];
            ...
            else if ([cell.labelStatus.text isEqualToString:@"Planned Load"])
            {
                [cell.btnCancelLoad setHidden:NO];
                [cell.btnEditLoad setHidden:YES];
                [cell.btnDeleteLoad setHidden:YES];
                ...
                [cell.btnDeleteLoad      setFrame:CGRectMake(62, 155, 25, 25)];
                [cell.btnFindTruck       setFrame:CGRectMake(91, 155, 25, 25)];
                [cell.btnShowDetails     setFrame:CGRectMake(32,155, 25, 25)];

            }
            
            else if ([cell.labelStatus.text isEqualToString:@"At Delivery Point"])
            {
                ...
                [cell.btnCancelLoad      setFrame:CGRectMake(151,  155, 25, 25)];
                [cell.btnEditLoad        setFrame:CGRectMake(32, 155, 25, 25)];
                [cell.btnDeleteLoad      setFrame:CGRectMake(62, 155, 25, 25)];
                [cell.btnFindTruck       setFrame:CGRectMake(91, 155, 25, 25)];
                [cell.btnShowDetails     setFrame:CGRectMake(8,155, 25, 25)];

                
            }
            else if ([cell.labelStatus.text isEqualToString:@"Unload"])
            {
                [cell.btnCancelLoad setHidden:YES];
                [cell.btnEditLoad setHidden:YES];
                [cell.btnDeleteLoad setHidden:YES];
            ...
            else if ([cell.labelStatus.text isEqualToString:@"Way to Delivery"])
            {
                [cell.btnCancelLoad setHidden:YES];
                [cell.btnEditLoad setHidden:YES];
                [cell.btnDeleteLoad setHidden:YES];
            ...
            else if ([cell.labelStatus.text isEqualToString:@"Ready To Move"])
            {
                [cell.btnCancelLoad setHidden:YES];
                [cell.btnEditLoad setHidden:YES];
                [cell.btnDeleteLoad setHidden:YES];
            ...
            else if ([cell.labelStatus.text isEqualToString:@"Delivered"])
            {
                [cell.btnCancelLoad setHidden:YES];
                [cell.btnEditLoad setHidden:YES];
                [cell.btnDeleteLoad setHidden:YES];
            ...
            else if ([cell.labelStatus.text isEqualToString:@"Loaded"])
            {
                [cell.btnCancelLoad setHidden:YES];
                [cell.btnEditLoad setHidden:YES];
                [cell.btnDeleteLoad setHidden:YES];
            ...
            else if ([cell.labelStatus.text isEqualToString:@"Cancelled"])
            {
                [cell.btnCancelLoad setHidden:YES];
                [cell.btnEditLoad setHidden:NO];
                [cell.btnDeleteLoad setHidden:NO];
                ...
                [cell.btnCancelLoad      setFrame:CGRectMake(8,  155, 25, 25)];
                [cell.btnEditLoad        setFrame:CGRectMake(8, 155, 25, 25)];
                [cell.btnDeleteLoad      setFrame:CGRectMake(32, 155, 25, 25)];
                [cell.btnFindTruck       setFrame:CGRectMake(91, 155, 25, 25)];
                [cell.btnShowDetails     setFrame:CGRectMake(8,155, 25, 25)];
...
{
    RSPlannedDetailsViewController *detailsVc =[self.storyboard instantiateViewControllerWithIdentifier:@"RSPlannedDetailsViewController"];
    detailsVc.receiveDataDict = [self.dataArray objectAtIndex:indexPath.row];
...
-(void)cancelBtnPressed:(UIButton *)sender
{
    ...
    NSIndexPath *aIndexPath = [_rTableView indexPathForRowAtPoint:buttonPosition];
        ...
        RSCancelLoadViewController *updateVc = [self.storyboard instantiateViewControllerWithIdentifier:@"RSCancelLoadViewController"];
...
-(void)editBtnPressed:(UIButton *)sender
{
    ...
    RSAddLoadViewController *updateVc = [self.storyboard instantiateViewControllerWithIdentifier:@"RSAddLoadViewController"];
    updateVc.receiveDatDict = [self.dataArray objectAtIndex:aIndexPath.row];
    [self.navigationController pushViewController:updateVc animated:YES];
}
-(void)deleteBtnPressed:(UIButton *)sender
{
    ...
    UIAlertView *deletAlert = [[UIAlertView alloc]initWithTitle:INFO message:DELETE_LOAD delegate:self cancelButtonTitle:@"YES" otherButtonTitles:@"No", nil];
    deletAlert.alpha = 1.0;
    deletAlert.tag = aIndexPath.row;
    [deletAlert show];
...
//    CGPoint buttonPosition = [sender convertPoint:CGPointZero toView:_rTableView];
//    NSIndexPath *aIndexPath = [_rTableView indexPathForRowAtPoint:buttonPosition];
//    if ([sender.titleLabel.text isEqualToString:@"Assign Truck"])
//    {
//        RSAllAssignTruckViewController *biddingDetails = [self.storyboard instantiateViewControllerWithIdentifier:@"RSAllAssignTruckViewController"];
//        biddingDetails.receiveDataDict = [self.dataArray objectAtIndex:aIndexPath.row];
//        [self.navigationController pushViewController:biddingDetails animated:YES];
//    }
//    else if([sender.titleLabel.text isEqualToString:@"Show Details"])
//    {
//        RSPlannedShowDetailsViewController *biddingDetails = [self.storyboard instantiateViewControllerWithIdentifier:@"RSPlannedShowDetailsViewController"];
//        biddingDetails.receiveDataDict = [self.dataArray objectAtIndex:aIndexPath.row];
//        [self.navigationController pushViewController:biddingDetails animated:YES];
//       
//    }
...
//{
//    if (cell.btnAssignTruck.hidden == true)
//    {
//        return 268;
//    }
//    else
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (alertView.alpha == 1)
    {
        if (buttonIndex == 1)
        {
            [self deleteLoad:(int)alertView.tag];
        }
        
    }
}

#pragma  mark deleteLoad
-(void)deleteLoad:(int)indexPathRow
{
...
//        NSDictionary *logDict = [NSKeyedUnarchiver unarchiveObjectWithData:[[NSUserDefaults standardUserDefaults] objectForKey:@"loginData"]];
//        
//        NSString *userUpdate = [NSString stringWithFormat:@"{\"id\":%@,\"CreatedBy\":\"%@\",\"Status\":\"%@\",\"pageIndex\":%d,\"PageSize\":%d,\"TruckRequestStatus\":%@,\"IsAll\":%d}",[logDict objectForKey:@"subscriptionId"],[logDict objectForKey:@"emailId"],@"0",pageIndx,pageSiz,@"1" ,false];
//        NSLog(@"%@",userUpdate);
//        
//        //{"SubscriptionId":30073,"Status":5,"TruckRequestStatus":0,"CreatedBy":"ranjit.singh@quikhop.com","IsAll":false,"PageIndex":1,"PageSize":5}
//        

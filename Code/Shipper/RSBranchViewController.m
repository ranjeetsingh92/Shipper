...
@implementation RSBranchViewController
...
- (void)viewDidLoad {
    ...
    [SVProgressHUD show];
    [self performSelector:@selector(getBranches) withObject:nil afterDelay:0];
    [NSTimer scheduledTimerWithTimeInterval:30 target:self selector:@selector(getBranches) userInfo:nil repeats:YES];
...
-(void)getBranches
{
    ...
    NSString *completeLoginUrlWithSpace = [NSString stringWithFormat:@"%@%@",DOMAIN_URL,GET_ALL_BRANCHES];
    ...
    [NSURLConnection sendAsynchronousRequest:request
                           ...
                           completionHandler:^(NSURLResponse *response, NSData *data, NSError *error)
     {
         ...
         if (data != nil)
         {
             ...
             self.dataArray = [[NSMutableArray alloc]initWithArray:rsJson];
...
{
    RSAddNewBranchViewController *newBranch = [self.storyboard instantiateViewControllerWithIdentifier:@"RSAddNewBranchViewController"];
    ...
    [NSURLConnection sendAsynchronousRequest:request
                           ...
                           completionHandler:^(NSURLResponse *response, NSData *data, NSError *error)
     {
         if (data != nil)
         {
             ...
             NSMutableArray *array = [NSJSONSerialization JSONObjectWithData:mData options:0 error:nil];
...
-(void)deleteBtnPressed:(UIButton *)sender
{
    ...
    NSString *completeLoginUrlWithSpace = [NSString stringWithFormat:@"%@%@",DOMAIN_URL,DELETE_BRANCH];
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] initWithURL:[NSURL URLWithString:completeLoginUrlWithSpace]];

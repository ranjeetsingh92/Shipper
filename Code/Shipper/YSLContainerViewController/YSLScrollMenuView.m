...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _itemSelectedTitleColor = [UIColor colorWithRed:153.0f/255 green:0.0f/255 blue:0.0f/255 alpha:1.0];
        _itemIndicatorColor = [UIColor colorWithRed:153.0f/255 green:0.0f/255 blue:0.0f/255 alpha:1.0];
...
- (void)setIndicatorViewFrameWithRatio:(CGFloat)ratio isNextItem:(BOOL)isNextItem toIndex:(NSInteger)toIndex
{
    ...
    {
        _indicatorView.frame = CGRectMake(100, _scrollView.frame.size.height - kYSLIndicatorHeight, kYSLScrollMenuViewWidth, kYSLIndicatorHeight);
        
    }
    if (app.selectedTab == 3)
    {
        _indicatorView.frame = CGRectMake(200, _scrollView.frame.size.height - kYSLIndicatorHeight, kYSLScrollMenuViewWidth, kYSLIndicatorHeight);
        
    }
    if (app.selectedTab == 4)
    {
        _indicatorView.frame = CGRectMake(300, _scrollView.frame.size.height - kYSLIndicatorHeight, kYSLScrollMenuViewWidth, kYSLIndicatorHeight);
        
    }
    if (app.selectedTab == 5)
    {
        _indicatorView.frame = CGRectMake(400, _scrollView.frame.size.height - kYSLIndicatorHeight, kYSLScrollMenuViewWidth, kYSLIndicatorHeight);
        
    }
    if (app.selectedTab == 6)
    {
        _indicatorView.frame = CGRectMake(500, _scrollView.frame.size.height - kYSLIndicatorHeight, kYSLScrollMenuViewWidth, kYSLIndicatorHeight);
